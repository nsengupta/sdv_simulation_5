...
**Livedoc roadmap:** [`PLAN.md`](PLAN.md). This file is the detailed archive of phase gates.
...
Design: [`archive/superpowers/specs/2026-07-18-phase-4-emulator-session-design.md`](superpowers/specs/2026-07-18-phase-4-emulator-session-design.md).
...
Design: [`archive/superpowers/specs/2026-07-18-phase-5-dashboard-presentation-design.md`](superpowers/specs/2026-07-18-phase-5-dashboard-presentation-design.md).  
...
- Still deferred — canonical list:
  [`TODO-simulation-5.md`](TODO-simulation-5.md) § **Important missing TBDs (for final README)**
  (Active ROB turns, coloured `Swatch`, Notice colours, glyph ASCII fallback / animation,
  richer assembly detail, zone-encased headlamp unconfirmed, shutdown/disband → Phase 10)
...
Design: [`archive/superpowers/specs/2026-07-19-phase-6-gateway-dashboard-split-design.md`](superpowers/specs/2026-07-19-phase-6-gateway-dashboard-split-design.md).  
Plan: [`archive/superpowers/plans/2026-07-19-phase-6-gateway-dashboard-split.md`](superpowers/plans/2026-07-19-phase-6-gateway-dashboard-split.md).
...
4. Update [`ARCHITECTURE-OVERVIEW.md`](ARCHITECTURE-OVERVIEW.md) gap register and [`DESIGN.md`](../DESIGN.md) / [`PLAN.md`](../PLAN.md) if behaviour changed.
